...
void main() {
  ...
  Widget buildApp(Widget child, {AssetBundle? bundle}) {
    return MaterialApp(
...
''';
  ...
  group('MainPage', () {
    testWidgets('shows frosted status bar and snackbar on action', (
      ...
      await tester.pumpWidget(buildApp(const MainPage()));
  ...
  group('DiaryReadPage', () {
    testWidgets('renders list of local diary entries', (tester) async {
      await tester.pumpWidget(buildApp(DiaryReadPage()));
  ...
  group('DiaryWritePage', () {
    testWidgets('renders form fields for writing diary', (tester) async {
      await tester.pumpWidget(buildApp(const DiaryWritePage()));
  ...
  group('Home and Garden flow', () {
    testWidgets('navigates to garden main page', (tester) async {
      await tester.pumpWidget(buildApp(const HomePage(), bundle: svgBundle()));
    ...
    testWidgets('garden page shows summary and analysis guide', (tester) async {
      await tester.pumpWidget(
        buildApp(const GardenMainPage(), bundle: svgBundle()),
      );
  ...
  group('MyForestPage', () {
    testWidgets('loads year view grid after data fetch', (tester) async {
      await tester.pumpWidget(
        buildApp(const MyForestPage(initialMode: ViewMode.year)),
      );
